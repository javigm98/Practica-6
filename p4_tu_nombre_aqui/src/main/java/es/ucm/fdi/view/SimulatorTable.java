...
public class SimulatorTable extends JPanel{
	...
	/**
	 * 
	 * @param fieldNames nombres de las columnas de la tabla
	 * @param elements lista de objetos a partir de la cual se rellena la tabla
	 */
	...
	/**
	 * @param elements lista con los elementos cuya informacion 
