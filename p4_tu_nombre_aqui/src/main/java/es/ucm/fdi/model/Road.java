...
/**
 * Clase que representa una carretera en el simulador. Tiene como atributos,
 * aparte de los hererdados por ser un simObject, su longitud (longitud), su
 * velocidad máxima (maxVel) y un mapa con los Vehículos ordenados en orden
 * inverso por sus posiciones. Además contiene referencias a los cruces inicial
 * (cruceIni) y final (cruceFin) de la carretera.
 * 
...
public class Road extends SimObject {
	...
	protected MultiTreeMap<Integer, Vehicle> listaVehiculos = new MultiTreeMap<Integer, Vehicle>(
			Collections.reverseOrder());
	private Junction cruceIni, cruceFin;

	public Road(String id, int longitud, int maxVel, Junction cruceIni,
			Junction cruceFin) {
		this.id = id;
	...
	/**
	 * Método que implementa la operación avanzar en una carretera. Tras
	 * calcular la velocidad de cada vehículo, cambia la velocidad de estos e
	 * invoca a su método avanzar. Internamente, va guaradando las
	 * modificaciones en le avance de los vehículos en un mapa auxiliar que
	 * luego copia como lista de vehículos de la carretera.
	 */
	@Override
	public void avanza() {
		long max;
	...
	/**
	 * Añade un nuevo vehículo a la carretera, colocándolo en la posición 0 de
	 * la misma.
	 * 
	 * @param v
	 *            Vehículo a introducir en la carretera.
	 */
	 ...
	 * 
	 * @param v
	 *            Vehículo a sacar de la carretera.
	 */
