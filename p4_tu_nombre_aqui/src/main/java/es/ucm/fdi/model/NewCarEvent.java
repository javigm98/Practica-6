...
public class NewCarEvent extends NewVehicleEvent {
	...
	/**
	 * Metodo que añade un nuevo coche al simulador con los datos que tenemos si
	 * le es momento de añadirlo. Lanza una excepción si no se puede crear el
	 * coche con el constructor de Car.
	 */
	...
	public void execute(RoadMap rm, int timeExecution)
		...
		if (time == timeExecution) {
			...
			Car c = new Car(id, maxSpeed, itinerario, resistencia, tMaxAveria,
					probAveria, semilla);
			rm.addVehicle(c);
