...
/**
 * Clase genérica que representa cualquier objeto de la simulación. Cuenta con
 * dos atributos que indican el identificador del objeto (id) y el tiempo
...
public abstract class SimObject implements Describable {
	...
	/**
	 * Avanza un paso la simulación del objeto correspondiente realizando las
	 ...
	 * 
	 * @param out
	 *            mapa en el que se guardan las claves y los valores asociados a
	 *            estos para generar posteriormente el informe correspondiente.
	 */
	 ...
	 * 
	 * @param time
	 *            timepo de la simulación
	 * @param out
	 *            mapa en el que se guardan las relaciones clave-valor de los
	 *            campos a mostrar en el objeto.
	 */
