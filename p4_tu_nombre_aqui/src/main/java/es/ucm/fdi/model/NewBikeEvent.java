...
public class NewBikeEvent extends NewVehicleEvent {
	...
	/**
	 * Metodo que añade una nueva bici al simulador con los datos que tenemos si
	 * le es momento de añadirla. Lanza una excepción si no se puede crear la
	 * bici con el constructor de Bike.
	 */
	@Override
