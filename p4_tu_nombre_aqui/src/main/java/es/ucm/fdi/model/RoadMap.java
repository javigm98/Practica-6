...
/**
 * Clase que almacena tres listas con los vehículos, cruces y carreteras que se
 * encuentran en la simulación en un momento dado.
 * 
...
public class RoadMap {
	 ...
	 * @return el vehículo con el id pasado como parámetro o null en caso de no
	 *         haber ningún vehículo con ese id.
	 */
	 ...
	 * 
	 * @param id
	 *            id del cruce a buscar.
	 * @return el cruce con el id pasado como parámetro o null en caso de no
	 *         haber ningún vehículo con ese id.
	 */
	public Junction getJunction(String id) throws SimulatorException {
		// Si se recorre la lista y no ha devuleto nada aun es que el cruce no
		// esta
		...
		throw new SimulatorException("Could not find junction with the id: "
				+ id + ". Expected ids: " + getListaCruces());

	}

	/**
	 * @param id
	 *            id del cruce del que queremos comprobar su existencia
	 * @return true si existe un cruce con el id dado, false si no
	 */

	public boolean junctionExist(String id) {
		for (Junction j : listaCruces) {
			if (j.getId().equals(id))
				return true;
		}
	 ...
	 * 
	 * @param id
	 *            id de la carretera a buscar.
	 * @return la carretera con el id pasado como parámetro o null en caso de no
	 *         haber ningún vehículo con ese id.
	 */
	public Road getRoad(String id) {
		// Si se recorre la lista y no ha devuleto nada aun es que la carretera
		// no esta y se devuelve null.
