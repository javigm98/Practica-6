...
/**
 * Representa una autopista en el simulador y extiende la clase Road, añadiendo un nuevo atributo
 * referente al número de carriles.
 ...
 */
	...
	/**
	 * Método que avanza la simulación en un aatopista, considerando el numero de vehículos y carriles además de las 
	 * averías para el cálculo de la velocidad base y el factor de reducción.
	 */
	@Override
	public void avanza(){
		long max;
