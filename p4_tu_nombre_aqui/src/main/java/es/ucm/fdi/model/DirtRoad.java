...
/**
 * Esta clase representa un dirt road en el simulador, extendiendo la clase
 * Road, sin añadir ningún atributo más.
 * 
...
public class DirtRoad extends Road {
	 ...
	 * @param fin
	 */
	public DirtRoad(String id, int longitud, int maxVel, Junction ini,
			Junction fin) {
		super(id, longitud, maxVel, ini, fin);
	}

	/**
	 * El metodo avanza de un DirtRoad es bastante similar al de de Road con la
	 * unica diferencia de que el factor de reduccion depende del número de
	 * vehículos averiados delante del que queremos avanzar y la velocidad base
	 * es siempre la máxima del camino.
	 * 
	 */
	@Override
	public void avanza() {
