...
public class Stepper {
	 ...
	 * 
	 * @param before
	 *            runnable que se ejecuta antes de el avance de la simulacion
	 * @param during
	 *            runnable que se ejecuta cada paso de la simulacion
	 * @param after
	 *            runnable que se ejecuta tras concluirse la simulacion
	 */
	 ...
	 * 
	 * @param steps
	 *            numero de pasos que avanza
	 * @param delay
	 *            tiempo entre cada paso
